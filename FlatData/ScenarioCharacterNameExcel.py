...
def ScenarioCharacterNameExcelAddNicknameKe(builder, nicknameKe):
    builder.PrependUOffsetTRelativeSlot(3, flatbuffers.number_types.UOffsetTFlags.py_type(nicknameKe), 0)

def AddNicknameKe(builder, nicknameKe):
    ScenarioCharacterNameExcelAddNicknameKe(builder, nicknameKe)
