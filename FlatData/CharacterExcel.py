...
def CharacterExcelCreateEquipmentSlotVector(builder, data):
    data = list(data)
...
def CreateEquipmentSlotVector(builder, data):
    CharacterExcelCreateEquipmentSlotVector(builder, data)
...
def CharacterExcelCreateTagsVector(builder, data):
    data = list(data)
    builder.StartVector(4, len(data), 4)
    for item in reversed(data):
        builder.PrependInt32(item)
...
def CreateTagsVector(builder, data):
    CharacterExcelCreateTagsVector(builder, data)
